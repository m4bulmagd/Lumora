...
| DES-11 | §11 Rendering and workstation UI | M4 viewer and startup sidebar; merged [M9 Task 2 controls](milestones/m09-processing-controls.md#pr-18-integration); local [Task 3 display modes/Compare](milestones/m09-compare.md) | Task 2 local/PR checks passed; Task 3 clean `f1848ec` Debug/Release 60/60 plus X11 1/1 each and actual Compare layout passed | Task 2 PR Debug/Release CI passed; Task 3 CI and native Windows visual/DPI pending | Task 2 merged through PR #18; Task 3 implemented locally, unpublished; M4 unaccepted |
