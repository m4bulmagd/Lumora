...
| `FramePresenter.DestructionClearsObserverAndDisconnectsViewIntents`, `ResetSourceAcceptsLowerIdAndResetsSessionState`, `ResetSourceReleasesOldPresenterAndViewportOwnership` | Teardown, source-session identity reset and ownership release | Local deterministic Task 4 UI tests |
