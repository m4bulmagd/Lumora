...
| DES-11 | §11 Rendering and workstation UI | Merged M9 controls/Compare/settings through PR #21; local [Task 4C ROI/format](milestones/m09-format-roi.md) and [Task 4D installation UI](milestones/m09-camera-profiles.md) | Task 4D Debug/Release 66/66, X11 1/1 each, inspected operator/admin layouts at `10e1018` | Earlier Task 4B PR CI passed; Task 4D Windows execution and native visual/DPI pending | Local Task 4C/D implemented; compact panel, capability details and Task 5 remain; M9 unaccepted |
...
| DES-13 | §13 Configuration and presets | [Merged presets](milestones/m09-presets.md#pr-17-integration) plus local [Task 4D schema 4 per-camera preferences and machine schema 1](milestones/m09-camera-profiles.md) | Migrations, bounded writer, read/write authority and installation binding verified at `10e1018`; targeted sanitizers pass | Earlier preset PR CI passed; Task 4D Windows owner/ACL/UAC execution pending | Local Task 4D implemented; admission, activation and durable persistence remain distinct |
