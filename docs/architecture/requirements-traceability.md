...
| DES-11 | §11 Rendering and workstation UI | M4 viewer and production startup sidebar; [M9 Task 2](milestones/m09-processing-controls.md) adds processing controls and Enhanced preview | Task 2 Debug/Release 58/58, native X11 1/1 each and actual-panel layout verified at `e55cddf` | Task 2 PR Debug/Release CI passed; native Windows visual/DPI pending | Task 2 merged through PR #18; switching and Compare remain Task 3; M4 unaccepted |
