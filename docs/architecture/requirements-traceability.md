...
| DES-11 | §11 Rendering and workstation UI | M4 viewer and production startup sidebar; [M9 Task 2](milestones/m09-processing-controls.md) adds local processing controls and Enhanced preview | Task 2 Debug/Release 58/58, native X11 1/1 each and actual-panel layout verified at `e55cddf` | Integrated M5 CI verified; Task 2 CI and native Windows visual/DPI pending | Task 2 local/unpublished; switching and Compare remain Task 3; M4 unaccepted |
...
| DES-13 | §13 Configuration and presets | [M9 preset state and schema3 migration](milestones/m09-presets.md#pr-17-integration) merged through PR #17; local Task 2 adds selector/live controls and a single preferences writer | Task 1 PR Debug/Release CI passed; Task 2 local 58/58 plus X11 per configuration at `e55cddf` | Task 1 PR Debug/Release CI passed; Task 2 CI pending | Task 1 merged; Task 2 local/unpublished; admission, activation and durable persistence remain distinct |
