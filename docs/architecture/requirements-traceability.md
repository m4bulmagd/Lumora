...
| DES-13 | §13 Configuration and presets | Schema2 startup persistence is integrated; [M9 preset state and schema3 migration](milestones/m09-presets.md) are in development | M5 Tasks4–5 verified; M9 evidence follows below | M5 Tasks4–5 CI verified at `5e1c1ec`; M9 CI pending | Preset selector/full editor remain later M9 work; admission is not persistence |
