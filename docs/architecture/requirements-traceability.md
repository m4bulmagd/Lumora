...
| DES-11 | §11 Rendering and workstation UI | M4 viewer/startup sidebar; merged [M9 processing controls](milestones/m09-processing-controls.md#pr-18-integration), [display modes/Compare](milestones/m09-compare.md#pr-19-integration) and [Task 4A settings](milestones/m09-camera-settings.md#pr-20-integration) | Task 4A local and PR Debug/Release 62/62 plus X11 1/1 each; actual dialog layouts passed | Task 4A PR Debug/Release 62/62 each; native visual/DPI pending | Tasks 2/3/4A merged through PR #18/#19/#20; FPS/ROI/format/acquisition mode remain read-only; M4 unaccepted |
