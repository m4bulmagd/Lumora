...
| DES-11 | §11 Rendering and workstation UI | Merged M9 controls/Compare/settings through PR #21; local Tasks 4C–4E through [compact camera controls and capability access](milestones/m09-camera-controls.md) | Full Debug/Release 68/68 and native UI/smoke at production `2be3a85`; simulator and sanitizer reruns at test-only `ef28052` | Earlier Task 4B PR CI passed; local Task 4C–4E Windows execution and native visual/DPI pending | Task 4 locally complete; QML migration selected but unimplemented; Task 5 and M9 acceptance remain open |
