...
| DES-11 | §11 Rendering and workstation UI | M4 viewer/startup sidebar; merged [M9 processing controls](milestones/m09-processing-controls.md#pr-18-integration), [display modes/Compare](milestones/m09-compare.md#pr-19-integration) and [Task 4A settings](milestones/m09-camera-settings.md#pr-20-integration) plus [Task 4B FPS editing](milestones/m09-frame-rate.md#pr-21-integration) | Task 4B local and PR Debug/Release 62/62 plus X11 1/1 each; actual dialog layouts passed | Task 4B PR Debug/Release 62/62 each; native visual/DPI pending | Tasks 2/3/4A/4B merged through PR #18/#19/#20/#21; ROI/format/acquisition mode remain read-only; M4 unaccepted |
...
| DES-13 | §13 Configuration and presets | [M9 preset state and schema3 migration](milestones/m09-presets.md#pr-17-integration) merged through PR #17; merged Task 2 adds selector/live controls and a single preferences writer | Task 1 PR Debug/Release CI passed; Task 2 local 58/58 plus X11 per configuration at `e55cddf` | Task 1 and Task 2 PR Debug/Release CI passed | Task 1 and Task 2 merged; admission, activation and durable persistence remain distinct |
