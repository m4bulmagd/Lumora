...
| M8 | Task 1 reviewed and merged through [PR #10](https://github.com/m4bulmagd/Lumora/pull/10); Linux Debug/Release 42/42 and Windows 41/41; Task 2 CLAHE implemented locally at `f5d6642`, review/verification in progress | Tasks 2–5, designated Windows references/performance, allocation and deferred acceptance gates remain open |
