...
This is documentation preparation only. M5 implementation has not started, M4 is not accepted, and no Windows stress/visual/packaging/hardware evidence is implied.
