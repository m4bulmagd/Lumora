...
The subsequent Task 2 approval adds the [dedicated acquisition worker checkpoint](../architecture/milestones/m05-acquisition-worker.md): implementation and Linux Debug/Release verification are recorded separately from its review and pending Windows evidence. Tasks 3–5 still own processing, startup controls/preferences and visible production live composition.
