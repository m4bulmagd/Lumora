...
TEST(PresetCodec, SchemaOneAndTwoMigrationPreserveLegacyAndNormalizeToSchemaFive) {
    ...
    EXPECT_EQ(one.value().schemaVersion, 5); EXPECT_EQ(two.value().schemaVersion, 5);
    ...
    EXPECT_EQ(normalized.value("schemaVersion").toInt(), 5);
