...
// General live admission; capability validation is performed separately.
[[nodiscard]] bool isSupportedLiveCameraConfiguration(const camera::CameraConfiguration& requested);
