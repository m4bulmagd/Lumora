...
int main(int argc,char** argv) {
    ...
    try {
        ...
        root={{"schemaVersion",2},{"artifactType","lumora.processing.benchmark"},{"runStatus","incomplete"},{"complete",false},{"workload",QJsonObject{{"kind",qs(o.workload)},{"requestedSizes",sizes},{"warmUpFrames",integer(o.warmUp)},{"measuredFrames",integer(o.measured)}}},{"generatedUtc",utcNow()},{"rows",QJsonArray{}},{"failure",QJsonValue()}};
