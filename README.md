...
M7 simulator development is underway on `feat/m07-high-bit-depth`. Tasks 1–3 provide reviewed processing contracts, deterministic U16 normalization, window/level and terminal Gray8 mapping, with passing local Debug/Release component tests. The pooled engine and live integration are in progress. See the [M7 execution record](docs/architecture/milestones/m07-preflight.md); Windows verification and milestone acceptance remain pending.
